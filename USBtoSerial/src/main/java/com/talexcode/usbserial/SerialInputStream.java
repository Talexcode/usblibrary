...
public class SerialInputStream extends InputStream
{
    ...
    protected final com.talexcode.usbserial.UsbSerialInterface device;

    public SerialInputStream(com.talexcode.usbserial.UsbSerialInterface device)
    {
        this.device = device;
    ...
    public SerialInputStream(com.talexcode.usbserial.UsbSerialInterface device, int maxBufferSize)
    {
        this.device = device;
