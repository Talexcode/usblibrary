...
public class SerialBuffer
{
    ...
    public byte[] getDataReceived()
    {
        synchronized(this)
        {
            ...
            if(debugging)
                com.talexcode.usbserial.UsbSerialDebugger.printReadLogGet(dst, true);
            return dst;
        }
    }
    ...
    private class SynchronizedBuffer
    {
        ...
        synchronized void put(byte[] src)
        {
            ...
            if(debugging)
                com.talexcode.usbserial.UsbSerialDebugger.printLogPut(src, true);
        ...
        synchronized byte[] get()
        {
            ...
            if(debugging)
                com.talexcode.usbserial.UsbSerialDebugger.printLogGet(dst, true);
