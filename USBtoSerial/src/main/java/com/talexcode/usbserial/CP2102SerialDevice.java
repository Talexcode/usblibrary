...
import com.talexcode.utils.SafeUsbRequest;

public class CP2102SerialDevice extends com.talexcode.usbserial.UsbSerialDevice
{
    ...
    private com.talexcode.usbserial.UsbSerialInterface.UsbParityCallback parityCallback;
    private com.talexcode.usbserial.UsbSerialInterface.UsbBreakCallback breakCallback;
    private com.talexcode.usbserial.UsbSerialInterface.UsbFrameCallback frameCallback;
    private com.talexcode.usbserial.UsbSerialInterface.UsbOverrunCallback overrunCallback;
    ...
    public boolean syncOpen()
    {
        ...
        if(ret)
        {
            ...
            // Init Streams
            inputStream = new com.talexcode.usbserial.SerialInputStream(this);
            outputStream = new com.talexcode.usbserial.SerialOutputStream(this);
    ...
    public void setDataBits(int dataBits)
    {
        ...
        switch(dataBits)
        {
            case com.talexcode.usbserial.UsbSerialInterface.DATA_BITS_5:
                wValue |= 0x0500;
                break;
            case com.talexcode.usbserial.UsbSerialInterface.DATA_BITS_6:
                wValue |= 0x0600;
                break;
            case com.talexcode.usbserial.UsbSerialInterface.DATA_BITS_7:
                wValue |= 0x0700;
                break;
            case com.talexcode.usbserial.UsbSerialInterface.DATA_BITS_8:
                wValue |= 0x0800;
                break;
            default:
                return;
    ...
    public void setStopBits(int stopBits)
    {
        ...
        switch(stopBits)
        {
            case com.talexcode.usbserial.UsbSerialInterface.STOP_BITS_1:
                wValue |= 0;
                break;
            case com.talexcode.usbserial.UsbSerialInterface.STOP_BITS_15:
                wValue |= 1;
                break;
            case com.talexcode.usbserial.UsbSerialInterface.STOP_BITS_2:
                wValue |= 2;
                break;
            default:
                return;
    ...
    public void setParity(int parity)
    {
        ...
        switch(parity)
        {
            case com.talexcode.usbserial.UsbSerialInterface.PARITY_NONE:
                wValue |= 0x0000;
                break;
            case com.talexcode.usbserial.UsbSerialInterface.PARITY_ODD:
                wValue |= 0x0010;
                break;
            case com.talexcode.usbserial.UsbSerialInterface.PARITY_EVEN:
                wValue |= 0x0020;
                break;
            case com.talexcode.usbserial.UsbSerialInterface.PARITY_MARK:
                wValue |= 0x0030;
                break;
            case com.talexcode.usbserial.UsbSerialInterface.PARITY_SPACE:
                wValue |= 0x0040;
                break;
            default:
                return;
    ...
    public void setFlowControl(int flowControl)
    {
        switch(flowControl)
        {
            case com.talexcode.usbserial.UsbSerialInterface.FLOW_CONTROL_OFF:
                ...
                break;
            case com.talexcode.usbserial.UsbSerialInterface.FLOW_CONTROL_RTS_CTS:
                ...
                break;
            case com.talexcode.usbserial.UsbSerialInterface.FLOW_CONTROL_DSR_DTR:
                ...
                startFlowControlThread();
                break;
            case com.talexcode.usbserial.UsbSerialInterface.FLOW_CONTROL_XON_XOFF:
    ...
    */
    ...
    private boolean openCP2102()
    {
        ...
        if(setControlCommand(CP210x_SET_LINE_CTL, CP210x_LINE_CTL_DEFAULT,null) < 0)
            return false;
        setFlowControl(com.talexcode.usbserial.UsbSerialInterface.FLOW_CONTROL_OFF);
