...
public class FTDISioIds
{
    ...
    public static boolean isDeviceSupported(UsbDevice dev) {
        return com.talexcode.deviceids.Helpers.exists(ftdiDevices, dev.getVendorId(), dev.getProductId()) ||
                isMicrochipFtdi(dev);

    }

    static boolean isDeviceIdSupported(int vendorId, int productId) {
        return com.talexcode.deviceids.Helpers.exists(ftdiDevices, vendorId, productId);
    }
}
